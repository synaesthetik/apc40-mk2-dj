...
class RgbColors:
    ...
    class Zooming:
      ...
      Empty = Rgb.BLACK
    class PPM:
      """ Volume meter steps. Live 11 button elements take skin colours by
      name rather than raw colour objects, so the meter lives in the skin """
      Off = Rgb.BLACK
      Step0 = Rgb.GREEN.shade(2)
      Step1 = Rgb.GREEN
      Step2 = Rgb.YELLOW
      Step3 = Rgb.AMBER
      Step4 = Rgb.RED
